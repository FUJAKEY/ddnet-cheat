...
MACRO_CONFIG_STR(ClPhantomName, cl_phantom_name, 32, "record", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Phantom file name")
MACRO_CONFIG_INT(ClPhantomPlay, cl_phantom_play, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Play phantom recording")
